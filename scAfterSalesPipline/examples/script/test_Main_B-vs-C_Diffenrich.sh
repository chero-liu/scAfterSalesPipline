...
file_path=/gpfs/oe-scrna/liuchenglong/RaD/scAfterSalesPipline/scAfterSalesPipline/examples/result/M1/Main/Diffexp/B-vs-C/done.check
...
-infile  /gpfs/oe-scrna/liuchenglong/RaD/scAfterSalesPipline/scAfterSalesPipline/examples/result/M1/Main/Diffexp/B-vs-C/group_*-diff-pval-0.05-FC-1.5.xls \
