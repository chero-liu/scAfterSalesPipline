...
option_list <- list(
    ...
    make_option(c("-P", "--prefix"),
        type = "character", default = "case-vs-control",
...
volcano_plot(opt$prefix, opt$foldchange, opt$pvalue, opt$fdr)

# system(paste0("cp -r '/gpfs/oe-software/conda_envs/scrna_envs/pdf_overlap_checker/script/volcanoplot/差异火山图结果说明.pdf' ",opt$outputdir))
