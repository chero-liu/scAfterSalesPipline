...
from scAfterSalesPipline.init.__init__ import M4DIRECTORIES
...
class Module4(Step):
    def __init__(self, args):
        ...
        self.type = args.type
        self.directory_list = M4DIRECTORIES
    ...
    def init_yaml(self):
        ...
        with open(os.path.join(self.outdir, "config", "cfgM4.yaml"), "w") as file:
            yaml.dump(data, file)

    def load_data(self):
        type_path = os.path.join(self.outdir, "result", "M4", self.type)
